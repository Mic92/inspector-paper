...
\myfontsize
{
\begin{tabular}{m{1.4cm}|m{.8cm}|m{1.1cm}|m{.6cm}|m{1.2cm}|m{1.2cm}}
...
\caption{Runtime statistics of benchmarks with 16 threads (Detailed results are available here: \href{http://tinyurl.com/qa6xq7q}{Log details Web-link}) }                                                                                                                                      \label{tab:apps}
