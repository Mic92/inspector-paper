...
%We next present an overview of our approach formally present our algorithm for constructing the Concurrent Provenance Graph (CPG). We first present the preliminaries,
