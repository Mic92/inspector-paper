...
\myparagraph{Edges: dependencies} We distinguish between three kinds of edges: control, synchronization, and data-dependence edges.
...
\myparagraph{Control edges} We derive control edges to record the intra-thread causal order between sub-computations of the same thread based on their execution order. Sub-computations in a thread are totally ordered based on their execution order
