...
{\tt thunk}$\leftarrow 0$; // Initialize thunk counter\\

$ L_t[\alpha].H[{\tt thunk}]\leftarrow$ {\tt instruction}; // Start new thunk
...
\Begin{
// Add thunks within the executing sub-computation \\
{\tt thunk++;} // Increment thunk counter\\

$ L_t[\alpha].H[{\tt thunk}]\leftarrow$ {\tt instruction}; // Add new thunk
}
