...
This section describes the architecture and implementation of \projecttitle. The architecture of \projecttitle (shown in Figure~\ref{fig:basicSystem}) consists of two main components: threading library and OS support. The library exports the CPG as an extended interface in the {\tt perf} utility for supporting data provenance. We next describe these two components in detail.
