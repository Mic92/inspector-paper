...
Furthermore, we briefly describe three on-going case-studies where the generic interface exported by \projecttitle is being used to improve the dependability, security, and efficiency of software systems. \projecttitle is an active open-source project and the tool is publicly available to the research community for use in other workflows. 
