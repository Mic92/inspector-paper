...
These systems leverage the semantics of distributed protocols to derive a state-machine, and capture the lineage information by modifying the state-machine. Instead, we don't require any protocol-specific provenance. Albeit, we currently do not target distributed systems.
