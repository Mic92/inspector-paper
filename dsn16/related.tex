...
\myparagraph{Operating systems} Linux Provenance Module (LPM)~\cite{lpm}, a recently proposed system to provide operating system support to collect system-wide provenance. In contrast to LPM, \projecttitle is a user-space solution and does not require any modifications to the underlying OS. Secondly, unlike LPM, which collects provenance at the granularity of a process, we collect data provenance at a finer granularity of a thread.  
