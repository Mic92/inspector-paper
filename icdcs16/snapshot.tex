...
the userspace (indicated by advancing a pointer). %This results in gaps in the trace, if the userspace process is not fast enough in collecting the log data. 
