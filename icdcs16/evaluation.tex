...
Furthermore, the snapshot facility (described in $\S$\ref{sec:snapshot}) restricts the active area of space usage, and the user can reuse the space in the ring buffer after analyzing the log.
